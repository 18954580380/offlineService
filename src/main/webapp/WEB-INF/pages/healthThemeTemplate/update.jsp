  	...
  	if(themeName==""||themeName=="请填写主题名称" ){
  	  ...
  	  $.ajax({
            //几个参数需要注意一下
                ...
                url: "<%=path%>/healthTheme/saveUpdate",
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
            <div class="panel-body">
              <h3 style="margin-top: 0px" class="title">修改健康主题</h3>
              <!-- Start right -->
              <div class="col-md-12 col-lg-6" style="padding-left:0px">
                <a href="#" onclick="saveUpdate()" class="btn btn-rounded">保存</a>
      ...
      <div class="panel panel-default">
        <div class="panel-title">
         ...
         <div class="panel-body">
              ...
              <!-- 隐藏id -->
                <input value="${healthThemeTemplate.id }" name="id" type="hidden" id="id"/>
                <div class="form-group">
                  <label for="themeName" class="col-sm-1 control-label form-label">健康主题</label>
                  <div class="col-sm-8">
                    <input style="width: 220px" type="text" class="form-control" name="themeName" id="themeName"  value="${healthThemeTemplate.themeName}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-1 control-label form-label">关联因素</label>
                  <div class="col-sm-8">
                    <select class="selectpicker"  name="mainProblem" id="mainProblem" multiple title="${empty healthThemeTemplate.mainProblem?'主要问题':healthThemeTemplate.mainProblem }" value="${healthThemeTemplate.mainProblem}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select class="selectpicker" name="mainSymptom" id="mainSymptom" multiple title="${empty healthThemeTemplate.mainSymptom?'主要症状':healthThemeTemplate.mainSymptom }" value="${healthThemeTemplate.mainSymptom}">
                         <c:forEach items="${mainSymptoms}" var="ms" >
                             <option>${ms.name}</option>
                         </c:forEach>
                      </select>                  
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-1 control-label form-label"></label>
                  <div class="col-sm-8">
                    <select class="selectpicker"  name="positiveIndex" id="positiveIndex" multiple title="${empty healthThemeTemplate.positiveIndex?'阳性指标':healthThemeTemplate.positiveIndex }" value="${healthThemeTemplate.positiveIndex}">
                ...
                <div class="form-group">
                  <label class="col-sm-1 control-label form-label"></label>
                  <div class="col-sm-8">
                    <select class="selectpicker" name="healthRisk" id="healthRisk" multiple title="${empty healthThemeTemplate.healthRisk?'健康风险':healthThemeTemplate.healthRisk }" value="${healthThemeTemplate.healthRisk}">
                ...
                <div class="form-group">
                  <label class="col-sm-1 control-label form-label"></label>
                  <div class="col-sm-8">
                    <select class="selectpicker" multiple title="${empty healthThemeTemplate.ageGroup?'年龄段':healthThemeTemplate.ageGroup }" value="${healthThemeTemplate.ageGroup}"  name="ageGroup" id="ageGroup">
