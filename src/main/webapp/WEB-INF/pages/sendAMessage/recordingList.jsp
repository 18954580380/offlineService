					...
					background-color: #F9F9F9;color: white;height: 47px;font-weight: bold;">
                                ...
                                <table>
                                    <tr>
                                        <td class="switchSendClass" onclick="switchSend(${themeTaskId})"
                                            style="background-color: #666666;line-height: 36px;">客户提醒</td>
                                        <td class="switchSendClass" onclick="switchSend2(${themeTaskId})"
                                            style="background-color: #0D6FB8;line-height: 36px;">发送记录</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div id="" style="background-color: white;width:1065px; height: 526px;margin-left: 19px">
                                <table id="borrow-rep-table1" class="table table-bordered"
                                    ...
                                    <tbody>
                                    <c:forEach items="${list}" var="h" varStatus="status">
                                        <tr>
...
<script type="text/javascript">
    ...
    function sendMessage(){
        ...
        $.ajax({
            ...
            success: function () {
                $("#message").children().children().html("提交成功");
            }, error: function (data) {
                console.info("新增失败");
            }
        });
    ...
    function  returnPage(){
        publicAnyWhere('defaultForm',webRoot+'/healthStation/healthManagement-taskCenter.htm?','defaultZone');
    }
