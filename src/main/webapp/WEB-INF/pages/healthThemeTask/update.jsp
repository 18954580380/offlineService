        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="<%=path%>/updServiceTaskController" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="hidden" id="themeName" value="${healthThemeTemplate.themeName}" name="themeName" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="hidden" class="form-control"  name="servicesGroupInputId" value="${healthThemeTask.id}">
                                <input type="text" class="form-control" id="servicesGroupSelectId"
                                       name="servicesGroupInputName" value="${healthThemeTask.blocName}">
                            </div>
                            <div class="col-sm-2">
                            ...
                            <div id="subsidiaryDivId">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="subsidiaryTextId"
                                           name="subsidiaryInputName" value="${healthThemeTask.subordinateCompanyName}">
                                </div>
                                <div class="col-sm-2">
                                    <input type="button" class="btn btn-rounded btn-default" value="选择"
                          ...
                          <div class="form-group">
						    ...
						    <input value="${healthThemeTask.imgUrl}" id="imgUrl" name="imgUrl" type="hidden"/>
						    </label>
					     </div>
                         </div>
                        <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-prepend input-group">
                                                ...
                                                <input type="text" id="date-range-and-time-picker"
                                                       ...
                                                       name="activityTimeName" value="${healthThemeTask.serviceStartTime}-${healthThemeTask.serviceEndTime}"/>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="serviceLocationId"
                                       name="serviceLocationName" value="${healthThemeTask.serviceAddress}">
                            </div>
                        </div>
                        ...
                        <div id="appointmentPeriodDiv">
                                            ...
                                            <div class="controls">
                                                <div class="input-prepend input-group">
                                                    ...
                                                    <input type="text" class="form-control mydate"
                                                           name="appointmentPeriodAM1" value="${amStartTime}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="controls">
                                                <div class="input-prepend input-group">
                                                        <span class="add-on input-group-addon"><i
                                                                class="fa fa-calendar"></i></span>
                                                    <input type="text" class="form-control mydate"
                                                           name="appointmentPeriodAM2" value="${amEndTime}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="controls">
                                                <div class="input-prepend input-group">
                                                        <span class="add-on input-group-addon"><i
                                                                class="fa fa-calendar"></i></span>
                                                    <input type="text" class="form-control mydate"
                                                           name="appointmentPeriodPM1" value="${pmStartTime}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <div class="input-prepend input-group">
                                                        <span class="add-on input-group-addon"><i
                                                                class="fa fa-calendar"></i></span>
                                                    <input type="text" class="form-control mydate" name="appointmentPeriodPM2" value="${pmEndTime}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                 <select class="selectpicker" value="${healthThemeTask.timeInterval}" name="timeLagName" id="timeLagName" onchange="selectTimeSection(this)">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                    <textarea style="width: 80%;height:300px;" name="serviceIntroduction">${healthThemeTask.serviceIntroduction}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                    <textarea style="width: 80%;height:300px;" name="managementTarget">${healthThemeTask.managementTarget}</textarea>
                                <%--<input type="text" class="form-control" id="serveTheme">--%>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text"  id="inputcrowdid" class="form-control" class="form-control" style="250px">
                        ...
                        <div id="servicesAvailableAddParentDivId">
                            <div id="servicesAvailableAddDivId">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="itemCeiling">
                                        <input type="hidden" class="form-control" name="healthThemeServiceItemId" id="healthThemeServiceItemId">
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <table id="healthManagerTableId">
                                ...
                                <tr id="healthManagerTrd">
                                    <td>
                                        <div class="col-sm-2">
                                            <input type="hidden" class="form-control" name="managerId" style="width: 200px">
                                    ...
                                    <td>
                                        <div class="col-sm-2">
                                            <select name="servicesAvailableSelectManager">
                                                <option>请选择</option>
                                            </select>
                                        </div>
                                    </td>
                        ...
                        <div class="form-group">
                            ...
                            <table id="doctorTableId">
                                <tr id="doctorTrId">
                                    <td>
                                        <div class="col-sm-2">
                                            <input type="hidden" class="form-control"  name="doctorId" style="width: 200px">
                                    ...
                                    <td>
                                        <div class="col-sm-2">
                                            <select name="servicesAvailableSelectDoctor">
                                                <option>请选择</option>
                                            </select>
                                        </div>
                                    </td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" rows="3" style="width: 800px;" name="serviceSupport">${healthThemeTask.serviceSupport}</textarea>
                            </div>
                        </div>
                        <center>
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                healthThemeTemplateId();
            }
        });
        //回显健康主题option下拉框内容
        function healthThemeTemplateId(){
            var id = ${healthThemeTemplate.id};
            $("select[name='themeId']").find("option[value='" + id + "']").attr("selected",true);
        }
        //医生健康师option下拉框内容
        $.ajax({
            type: "GET",
        ...
        //回显服务人数上限
        var serviceCeiling = '${healthThemeTask.serviceCeiling}';
        $("#maxmemberInputId").val(serviceCeiling);

//        $("#maxmemberIdYes").checked=true;
//
//        if(serviceCeiling==0){
//            $("#maxmemberIdNo").checked=true;
//            maxmemberOnclick();
//        }else{
//            maxmemberOnclick();
//        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                servicesAvailableSelectSelected();
            }
        });
        //回显医生健康师option下拉框内容
        function selectdoctorSelect(){
            var json = '${healthThemeServiceItemJoinDoctor}';
            var obj = eval("("+ json +")");
            console.info(obj);
            var doctor = 0;
            var healthManager  = 0;
            ...
            if(healthManager>1){
                for(var i=0;i<healthManager-1;i++) {
                    healthManagerOnclick();
                }
                for(var i=0;i<list1.length;i++){
                    $($("input[name='managerId']")[i]).val(list1[i].id);
                    $($("input[name='managerName']")[i]).val(list1[i].doctorName);
                    $($("select[name='servicesAvailableSelectManager']")[i]).find("option[value='" + obj[i].serviceProject + "']").attr("selected",true);
                }
            }else {
                for (var i = 0; i < list1.length; i++) {
                    $($("input[name='managerId']")[i]).val(list1[i].id);
            ...
            if(doctor>1){
                for(var i=0;i<doctor-1;i++) {
                    doctorAddOnclick();
                }
                for(var i=0;i<list2.length;i++) {
                    $($("input[name='doctorId']")[i]).val(list2[i].id);
                    $($("input[name='doctorName']")[i]).val(list2[i].doctorName);
                    $($("select[name='servicesAvailableSelectDoctor']")[i]).find("option[value='" + obj[i].serviceProject + "']").attr("selected",true);
                }
            }else{
                for(var i=0;i<list2.length;i++) {
                    $($("input[name='doctorId']")[i]).val(list2[i].id);
        ...
        //回显服务团队
        function servicesAvailableSelectSelected(){
            var json = '${healthThemeServiceItem}';
            var obj = eval("("+ json +")");
            console.info(obj)
            if(obj.length>1){
                for(var i=1;i<obj.length;i++){
                    servicesAvailableAddId();
                }
                for(var i=0;i<obj.length;i++){
                    $($("input[name='itemCeiling']")[i]).val(obj[i].serviceProjectCeiling);
                    $($("input[name='healthThemeServiceItemId']")[i]).val(obj[i].id);
                    $($("select[name='servicesAvailableSelect']")[i]).find("option[value='" + obj[i].serviceProject + "']").attr("selected",true);
                    $($("select[name='isCheck']")[i]).find("option[value='" + obj[i].isCheck + "']").attr("selected",true);
                    $($("[name='itemContext']")[i]).val(obj[i].serviceContent);
                }
            }else{
                for(var i=0;i<obj.length;i++){
                    $($("input[name='itemCeiling']")[i]).val(obj[i].serviceProjectCeiling);
...
<script type="text/javascript">
    ...
    function subsidiaryDivExpBiz(){
        $('#subsidiaryRadioId tr').each(function(i){
            if(i>=1){
        ...
        $("#healthManagerDivDuttonId").click(function () {
            ...
            for (i; i < names.length; i++) {
                if (names[i].checked) {
                    ...
                    input.val( names[i].getAttribute('value'));
                    input.next().val(names[i].getAttribute('valueName'));
                }
            }
