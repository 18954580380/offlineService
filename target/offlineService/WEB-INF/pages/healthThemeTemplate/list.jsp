...
<head>
    ...
    <script type="text/javascript">
        ...
        function getSelectId() {
            var ids = "";
            $.each($('input[name=themeTemplate]:checked'), function () {
                if ($(this).val() != "") {
                    ids += $(this).val() + ",";
                }
            });
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3 style="margin-top: 0px" class="title">健康主题维护</h3>
                    <!-- Start right -->
                    <div class="col-md-12 col-lg-6" style="padding-left:0px">
                        <a href='<%=path%>/healthTheme/add' class="btn btn-rounded btn-default">新建</a>
                ...
                <div class="panel-body">
                    <form class="form-inline" id="search" action="">
                        <div class="form-group">
                            <label for="themeName" class="form-label">主题名称</label>
                            <input style="width: 230px" type="text" name="themeName" class="form-control" id="themeName"
                                   value="${themeName}">
                        </div>
...
<script>
    $(document).ready(function () {
        var dataTable = $("#templateTable").dataTable(options).api();
    ...
    }, "themeName", function (data) {
    	var str="";
    	if(data.mainProblem!=null){
    		str+=data.mainProblem+ "&nbsp;&nbsp;&nbsp;&nbsp";
    	}if( data.mainSymptom!=null){
    		str+=data.mainSymptom +"&nbsp;&nbsp;&nbsp;&nbsp";
    	}if(data.positiveIndex!=null){
    		str+=data.positiveIndex +"&nbsp;&nbsp;&nbsp;&nbsp";
    	}if(data.healthRisk!=null){
    		str+=data.healthRisk +"&nbsp;&nbsp;&nbsp;&nbsp";
    	}if(data.ageGroup!=null){
    		str+=data.ageGroup
    	}
        return  str;
    }];
    var options = page("<%=path%>/healthTheme/findTemplate", column, function (data) {
        return data.data;
    }, 'search');
</script>
</body>
