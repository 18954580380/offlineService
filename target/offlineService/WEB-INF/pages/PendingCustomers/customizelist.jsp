            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3 style="margin-top: 0px" class="title">
                        <font color="#4169e1">自定义添加客户</font>
                    </h3>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="fromId" class="form-inline">
                        ...
                        <button type="button" class="btn btn-default" id="selectButtonId">查询</button>
                        <button type="button" class="btn btn-default" style="float: right" onclick="saveCustomize()">添加客户</button>
                    </form>
                </div>
...
<script>
    ...
    function saveCustomize(){
        window.location.href="<%=path%>/pendingcustomers/customizePage";
    }
    ...
    var options = page("<%=path%>/pendingcustomers/customizeList", column, function (data) {
        return data.data;
    }, 'fromId');
